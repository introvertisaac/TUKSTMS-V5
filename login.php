...
<body class="bg-dark" style="background-color: #008080">


  <main id="main" >
  	
  		<div class="align-self-center w-100" >
		<h4 class="text-white text-center"><b>TUK STUDENT SUPPORT SYSTEM</b></h4>
  			...
  			<div class="card col-md-4">
  				<div class="card-body">
  					<form id="login-form" >
  						...
  						<center><button class="btn-sm btn-block btn-wave col-md-6 row-mt-6 btn-primary">Login</button></center>
  					</form>
  				</div>
  			</div>
  		</div>
